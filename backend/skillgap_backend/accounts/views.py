...
class UserDashboardView(APIView):
    ...
    def get(self,request):
        ...
        return Response({
            ...
            "pending_skills":Skill.objects.filter(user=request.user,status='PENDING').count(),
            "approved_skills":Skill.objects.filter(user=request.user,status='APPROVED').count(),
            "rejected_skills":Skill.objects.filter(user=request.user,status='REJECTED').count(),
        })
